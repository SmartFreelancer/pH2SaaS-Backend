 ...
 */
$config['site_title']                 = "Fiverr Tools";       // Site Title, example.com
$config['admin_email']                = "support@fiverrtools.com"; // Admin Email, admin@example.com
$config['default_group']              = 'registered';           // Default group, use name
 ...
 */
$config['remember_cookie_name'] = 'bt_act_cookie';
$config['identity_cookie_name'] = 'bt_act_user';
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'email_temp/';
...
$config['message_start_delimiter'] = '<div class="alert alert-info" role="alert">';    // Message start delimiter
$config['message_end_delimiter']   = '</div>';  // Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger" role="alert">';     // Error mesage start delimiter
