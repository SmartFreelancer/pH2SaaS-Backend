                  ...
                  <fieldset>
                     ...
                     <section>
                        ...
                        <label class="input"> <i class="icon-append fa fa-user"></i>
                           <input type="email" name="identity" id="identity" placeholder="Enter your username">
                     ...
                     <section>
                        ...
                        <label class="input"> <i class="icon-append fa fa-lock"></i>
                           ...
                           <b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> Please choose a password</b> </label>
                        ...
                        <b class="tooltip tooltip-bottom-right"><i class="fa fa-lock txt-color-teal"></i> Please confirm your password</b>
                        </label>
                        </section>
                        ...
                        <fieldset>
                           ...
                           <!-- <section>
                              ...
                              <i></i>
                              I agree with the
                              <a data-target="#myModal" data-toggle="modal" href="#"> Terms and Conditions </a>
                              </label>
                           </section> -->
                        </fieldset>
                  <footer>
...
<!-- Modal -->
 ...
 <div id="left">
            ...
            <h1>BOOSTERR TERMS & CONDITIONS TEMPLATE</h1>
...
<h2>About these website terms and conditions</h2><p>We created these website terms and conditions with the help of a free website terms and conditions form developed by Contractology and available at <a href="http://www.BOOSTERR.com">www.BOOSTERR.com</a>.
Contractology supply a wide variety of commercial legal documents, such as <a href="#">template data protection statements</a>.
    ...
    <a href="#">BOOSTERR.com</a>.  You must retain the credit
