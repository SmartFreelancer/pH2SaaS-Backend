                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4" style="padding-left: 0;">
                           ...
                           <form id="process-form">
                              ...
                              <input type="hidden" value="<?= $user->id; ?>" name="mod_user">
                              <input type="hidden" value="<?= time(); ?>" name="mod_date">
      ...
      $('#mod-submit-btn').click(function() {
         ...
         $.ajax({
            ...
            success:function() {
               ...
               window.location.href = "<?= base_url(); ?>admin/gig-analyzer/moderation/"+next_gig_id+"";
            },
            complete: function(){
               $('#process-loader').hide();
            }
      ...
      $('#mod-close-btn').click(function() {
         ...
         function(){
            ...
            $.ajax({
               ...
               success:function() {
                  window.location.href = "<?= base_url(); ?>admin/gig-analyzer";
               }
            });
         });
      });
