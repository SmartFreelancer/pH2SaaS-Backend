        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="jarviswidget" id="acp-ga-rs-list" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                        <header>
                            <span class="widget-icon"> <i class="fa fa-rocket"></i> </span>
                            <h2>Resubmitted Gigs</h2>
                        </header>
                        <div>
...
<script type="text/javascript">
    $(document).ready(function() {
          ...
          $('li#resubmit-list').addClass('active'); // make the current nav active
