...
<div id="main" role="main">
    ...
    <div id="ribbon">
        <ol class="breadcrumb">
            ...
            <li>Gig Image Creator Training</li>
        </ol>
    </div>
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="jarviswidget" id="gic-training" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                        <header>
                            <span class="widget-icon"> <i class="fa fa-image"></i> </span>
                            <h2>Gig Image Creator Training</h2>
