...
<div id="main" role="main" class="gs-img">
   ...
   <div id="content">
      ...
      <div class="alert alert-info">
        A list of all your gigs that are currently pending swap. All gigs will be swap automatically by the system with the next available gig.
      </div>
            ...
            <article class="col-md-12">
               <div class="jarviswidget" id="wdg-gs-pending" data-widget-editbutton="false" data-widget-deletebutton="false">
                  <header>
                     ...
                     <h2>Pending Swap (in swap queue)</h2>
                  </header>
                  <div>
