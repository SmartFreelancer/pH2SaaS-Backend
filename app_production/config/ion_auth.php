...
$config['invoice_new'] = 'invoice_new.tpl.php';
$config['invoice_due'] = 'invoice_due.tpl.php';
$config['invoice_overdue'] = 'invoice_overdue.tpl.php';
$config['welcome'] = 'welcome.tpl.php';
$config['membership_renewal'] = 'membership_renewal.tpl.php';
$config['membership_disabled'] = 'membership_disabled.tpl.php';
